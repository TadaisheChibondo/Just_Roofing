...
# SECRET_KEY = "django-insecure-&_5l^jdz&%y=6+tl_-oh4(qp%af(l!-2^+fg!=d+(!7_djz8d*"
SECRET_KEY = os.environ.get('SECRET_KEY', 'your-local-secret-key-fallback')
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:5173",
    "http://127.0.0.1:5173",
    "https://just-roofing.vercel.app"
]

# Media Files (For Product and Portfolio Images)
# import os
MEDIA_URL = '/media/'
...
# Force Django to use the Supabase public URL endpoint
AWS_S3_CUSTOM_DOMAIN = f"oqoqdjpdggrqbavfjrpx.supabase.co/storage/v1/object/public/{AWS_STORAGE_BUCKET_NAME}"
